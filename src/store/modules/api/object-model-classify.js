...
const actions = {
    ...
    searchClassificationsObjects ({ commit, state, dispatch, rootGetters }, { params = {}, config }) {
        let url = 'find/classificationobject'
        url = `${url}?${AJAX_MOCK_PARAM}=cmdb&invoke=classificationobject`
    ...
    getClassificationsObjectStatistics ({ state }, { config }) {
        let url = 'object/statistics'
        url = `${url}?${AJAX_MOCK_PARAM}=cmdb&invoke=statistics`
